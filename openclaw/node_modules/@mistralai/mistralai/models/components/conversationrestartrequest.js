...
/** @internal */
exports.ConversationRestartRequestHandoffExecution$outboundSchema = z
    .nativeEnum(exports.ConversationRestartRequestHandoffExecution);
/** @internal */
exports.ConversationRestartRequestAgentVersion$outboundSchema = z.union([z.string(), z.number().int()]);
