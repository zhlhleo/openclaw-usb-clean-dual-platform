...
/** @internal */
exports.Thinking$inboundSchema = z.union([toolreferencechunk_js_1.ToolReferenceChunk$inboundSchema, textchunk_js_1.TextChunk$inboundSchema]);
/** @internal */
exports.Thinking$outboundSchema = z.union([toolreferencechunk_js_1.ToolReferenceChunk$outboundSchema, textchunk_js_1.TextChunk$outboundSchema]);
...
exports.ThinkChunk$inboundSchema = z.object({
    ...
    thinking: z.array(z.union([toolreferencechunk_js_1.ToolReferenceChunk$inboundSchema, textchunk_js_1.TextChunk$inboundSchema])),
    closed: z.boolean().default(true),
});
/** @internal */
exports.ThinkChunk$outboundSchema = z.object({
    type: z.literal("thinking").default("thinking"),
    thinking: z.array(z.union([toolreferencechunk_js_1.ToolReferenceChunk$outboundSchema, textchunk_js_1.TextChunk$outboundSchema])),
    closed: z.boolean().default(true),
});
