...
import { I as sensitive } from "./zod-schema.core-DICsKVAU.js";
import { t as stripUrlUserInfo } from "./url-userinfo-DLBehkt7.js";
import { n as DISCORD_DEFAULT_LISTENER_TIMEOUT_MS, t as DISCORD_DEFAULT_INBOUND_WORKER_TIMEOUT_MS } from "./timeouts-DxxpJDAN.js";
...
const FIELD_HELP = {
	...
	"agents.defaults.compaction.truncateAfterCompaction": "When enabled, rewrites the session JSONL file after compaction to remove entries that were summarized. Prevents unbounded file growth in long-running sessions with many compaction cycles. Default: false.",
	...
	"channels.telegram.apiRoot": "Custom Telegram Bot API root URL. Use for self-hosted Bot API servers (https://github.com/tdlib/telegram-bot-api) or reverse proxies in regions where api.telegram.org is blocked.",
	"channels.telegram.autoTopicLabel": "Auto-rename DM forum topics on first message using LLM. Default: true. Set to false to disable, or use object form { enabled: true, prompt: '...' } for custom prompt.",
	"channels.telegram.autoTopicLabel.enabled": "Whether auto topic labeling is enabled. Default: true.",
	"channels.telegram.autoTopicLabel.prompt": "Custom prompt for LLM-based topic naming. The user message is appended after the prompt.",
