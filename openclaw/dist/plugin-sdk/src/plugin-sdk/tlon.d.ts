...
export declare const tlonSetupAdapter: import("./channel-setup.js").ChannelSetupAdapter;
export declare const tlonSetupWizard: import("./channel-setup.js").ChannelSetupWizard;
