...
export type LoadedConfig = ReturnType<typeof import("openclaw/plugin-sdk/config-runtime").loadConfig>;
...
type DiscordMessagePreflightSharedFields = {
    cfg: LoadedConfig;
    discordConfig: NonNullable<import("openclaw/plugin-sdk/config-runtime").OpenClawConfig["channels"]>["discord"];
    accountId: string;
    token: string;
    runtime: RuntimeEnv;
    botUserId?: string;
